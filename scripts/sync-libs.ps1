...
#   lib-python-projects -- pinned to an exact immutable tag (@v0.1.7). The
...
Write-Step "Libs synced: lib-python-config to release/0.x HEAD; lib-python-projects pinned at v0.1.7."
