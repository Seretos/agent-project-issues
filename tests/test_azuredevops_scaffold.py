...
from project_issues_plugin.providers.base import Comment, StatusSpec, Ticket
...
def test_provider_is_registered() -> None:
    ...
    assert "azuredevops" in _PROVIDERS
    assert isinstance(_PROVIDERS["azuredevops"], AzureDevOpsProvider)
...
def test_safe_translates_azuredevops_error() -> None:
    ...
    def boom():
        raise AzureDevOpsError(404, "Work item not found")

    assert _safe(boom) == {"error": "Azure DevOps 404: Work item not found"}
